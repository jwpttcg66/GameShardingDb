...
import com.snowcattle.game.db.service.jdbc.test.longEntity.onetoone.*;
...
//        MoreOrder proxyOrder = moreOrder;
        ...
        proxyOrder.setStatus("测试列表插入" + com.snowcattle.game.db.service.jdbc.test.longEntity.onetoone.JdbcTest.batchStart);
    ...
    public static void insertBatchTest(ClassPathXmlApplicationContext classPathXmlApplicationContext, OrderService orderService) throws Exception {
        MoreOrderService moreOrderService = getMoreOrderProxyService(classPathXmlApplicationContext);
        int startSize = com.snowcattle.game.db.service.jdbc.test.longEntity.onetoone.JdbcTest.batchStart;
