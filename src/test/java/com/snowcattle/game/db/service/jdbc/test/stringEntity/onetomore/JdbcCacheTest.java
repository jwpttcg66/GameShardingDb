...
//        com.snowcattle.game.db.service.jdbc.common.longEntity.onetomore.JdbcTest.deleteBatchTest(classPathXmlApplicationContext, orderService, orderList);
//    }
//
...
//        proxyOrder.setStatus("测试列表插入" + com.snowcattle.game.db.service.jdbc.common.longEntity.onetomore.JdbcTest.batchStart);
...
//        com.snowcattle.game.db.service.jdbc.common.longEntity.onetomore.JdbcTest.updateBatchTest(classPathXmlApplicationContext, orderService, orderList);
//    }
//
...
//        MoreOrderService moreOrderService = getMoreOrderProxyService(classPathXmlApplicationContext);
//        int startSize = com.snowcattle.game.db.service.jdbc.common.longEntity.onetomore.JdbcTest.batchStart;
...
//        return com.snowcattle.game.db.service.jdbc.common.longEntity.onetomore.JdbcTest.getMoreOrderList(classPathXmlApplicationContext, orderService);
//    }
//
//    public static void insertTest(ClassPathXmlApplicationContext classPathXmlApplicationContext, OrderService orderService) {
//        com.snowcattle.game.db.service.jdbc.common.longEntity.onetomore.JdbcTest.insertTest(classPathXmlApplicationContext, orderService);
//    }
//
//    public static Order getTest(ClassPathXmlApplicationContext classPathXmlApplicationContext, OrderService orderService) {
//       return com.snowcattle.game.db.service.jdbc.common.longEntity.onetomore.JdbcTest.getTest(classPathXmlApplicationContext, orderService);
//    }
//
...
//       com.snowcattle.game.db.service.jdbc.common.longEntity.onetomore.JdbcTest.updateTest(classPathXmlApplicationContext, orderService, order);
//    }
//
...
//      com.snowcattle.game.db.service.jdbc.common.longEntity.onetomore.JdbcTest.deleteTest(classPathXmlApplicationContext, orderService, order);
//    }
//
